    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <a href="<?= base_url('home/bimbingan_kp'); ?>">
            <div class="card border-left-primary shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Bimbingan KP</div>
                  </div>
                  <div class="col-auto">
        ...
        <!-- Info KP -->
        <div class="col-xl-3 col-md-6 mb-4">
          <a href="<?= base_url('home/info_kp_dosen'); ?>">
